...
export type ZeroExTransactionStructOutput = [BigNumber, BigNumber, BigNumber, string, string] & {
  salt: BigNumber
  expirationTimeSeconds: BigNumber
  gasPrice: BigNumber
  signerAddress: string
...
export type FillResultsStructOutput = [BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
...
export type BatchMatchedFillResultsStructOutput = [FillResultsStructOutput[], FillResultsStructOutput[], BigNumber, BigNumber] & {
...
export type MatchedFillResultsStructOutput = [FillResultsStructOutput, FillResultsStructOutput, BigNumber, BigNumber] & {
  left: FillResultsStructOutput
  right: FillResultsStructOutput
  profitInLeftMakerAsset: BigNumber
  profitInRightMakerAsset: BigNumber
...
export interface ExchangeContractInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'batchCancelOrders', values: [OrderStruct[]]): string
  encodeFunctionData(functionFragment: 'batchExecuteTransactions', values: [ZeroExTransactionStruct[], BytesLike[]]): string
  encodeFunctionData(functionFragment: 'batchFillOrKillOrders', values: [OrderStruct[], BigNumberish[], BytesLike[]]): string
  encodeFunctionData(functionFragment: 'batchFillOrders', values: [OrderStruct[], BigNumberish[], BytesLike[]]): string
  encodeFunctionData(functionFragment: 'batchFillOrdersNoThrow', values: [OrderStruct[], BigNumberish[], BytesLike[]]): string
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'cancelOrder', values: [OrderStruct]): string
  ...
  encodeFunctionData(functionFragment: 'executeTransaction', values: [ZeroExTransactionStruct, BytesLike]): string
  encodeFunctionData(functionFragment: 'fillOrKillOrder', values: [OrderStruct, BigNumberish, BytesLike]): string
  encodeFunctionData(functionFragment: 'fillOrder', values: [OrderStruct, BigNumberish, BytesLike]): string
  ...
  encodeFunctionData(functionFragment: 'getOrderInfo', values: [OrderStruct]): string
  encodeFunctionData(functionFragment: 'isValidHashSignature', values: [BytesLike, string, BytesLike]): string
  encodeFunctionData(functionFragment: 'isValidOrderSignature', values: [OrderStruct, BytesLike]): string
  encodeFunctionData(functionFragment: 'isValidTransactionSignature', values: [ZeroExTransactionStruct, BytesLike]): string
  encodeFunctionData(functionFragment: 'marketBuyOrdersFillOrKill', values: [OrderStruct[], BigNumberish, BytesLike[]]): string
  encodeFunctionData(functionFragment: 'marketBuyOrdersNoThrow', values: [OrderStruct[], BigNumberish, BytesLike[]]): string
  encodeFunctionData(functionFragment: 'marketSellOrdersFillOrKill', values: [OrderStruct[], BigNumberish, BytesLike[]]): string
  encodeFunctionData(functionFragment: 'marketSellOrdersNoThrow', values: [OrderStruct[], BigNumberish, BytesLike[]]): string
  encodeFunctionData(functionFragment: 'matchOrders', values: [OrderStruct, OrderStruct, BytesLike, BytesLike]): string
  encodeFunctionData(
...
export type AssetProxyRegisteredEvent = TypedEvent<[string, string], { id: string; assetProxy: string }>

export type AssetProxyRegisteredEventFilter = TypedEventFilter<AssetProxyRegisteredEvent>
...
export type FillEvent = TypedEvent<
  [string, string, string, string, string, string, string, string, string, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber],
  {
    makerAddress: string
    feeRecipientAddress: string
    makerAssetData: string
...
export type ProtocolFeeCollectorAddressEventFilter = TypedEventFilter<ProtocolFeeCollectorAddressEvent>
...
export type ProtocolFeeMultiplierEventFilter = TypedEventFilter<ProtocolFeeMultiplierEvent>
...
export type SignatureValidatorApprovalEventFilter = TypedEventFilter<SignatureValidatorApprovalEvent>

export type TransactionExecutionEvent = TypedEvent<[string], { transactionHash: string }>

export type TransactionExecutionEventFilter = TypedEventFilter<TransactionExecutionEvent>
...
export interface ExchangeContract extends BaseContract {
  ...
  functions: {
    ...
    detachProtocolFeeCollector(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
    ...
    preSign(hash: BytesLike, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
  ...
  getOrderInfo(order: OrderStruct, overrides?: CallOverrides): Promise<OrderInfoStructOutput>

  isValidHashSignature(hash: BytesLike, signerAddress: string, signature: BytesLike, overrides?: CallOverrides): Promise<boolean>

  isValidOrderSignature(order: OrderStruct, signature: BytesLike, overrides?: CallOverrides): Promise<boolean>
  ...
  callStatic: {
    ...
    batchCancelOrders(orders: OrderStruct[], overrides?: CallOverrides): Promise<void>
    ...
    executeTransaction(transaction: ZeroExTransactionStruct, signature: BytesLike, overrides?: CallOverrides): Promise<string>
  ...
  estimateGas: {
    ...
    cancelOrder(order: OrderStruct, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    detachProtocolFeeCollector(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    getOrderInfo(order: OrderStruct, overrides?: CallOverrides): Promise<BigNumber>
    ...
    isValidOrderSignature(order: OrderStruct, signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>
    ...
    preSign(hash: BytesLike, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<BigNumber>
    ...
    registerAssetProxy(assetProxy: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    detachProtocolFeeCollector(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
    ...
    getOrderInfo(order: OrderStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    isValidOrderSignature(order: OrderStruct, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    preSign(hash: BytesLike, overrides?: PayableOverrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
